...
public class CartItemController {
     ...
     */
    @PostMapping("/add")
    public ResponseEntity<DataResponse> addItemToCart(@RequestParam Long cartId, @RequestParam Long productId,
    ...
    public ResponseEntity<DataResponse> updateItemQuantity(@RequestParam Long cartId,
        ...
        try{
            ...
            return ResponseEntity.ok().body(new DataResponse<>("Item quantity updated!"));
        }
        catch (ResourceNotFoundException e){
            return ResponseEntity.status(HttpStatusCode.valueOf(404)).body(new DataResponse<>(e.getMessage()));
        }
